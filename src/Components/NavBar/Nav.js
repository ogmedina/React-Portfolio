...
function Navigation() {
    return (
        ...
        <Navbar className="navbar" collapseOnSelect expand="lg" bg="dark" fixed="top" variant="dark" id="mainNav">
            <Container>
            <Navbar.Brand className="navbar-brand" href="#page-top">Oscar Medina</Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav navbarResponsive" >
                <Nav className="ml-auto navbar-nav text-uppercase">
                    <Nav.Link className="nav-item nav-link js-scroll-trigger" href="#services">Services</Nav.Link>
                    <Nav.Link className="nav-item nav-link" href="#portfolio">Portfolio</Nav.Link>
                    <Nav.Link className="nav-item nav-link" href="#experience">Experience</Nav.Link>
